...
#from auxiliary import invert_dict

ref_path = os.path.dirname(__file__)

def gset_as_dict(subsel=None):
    ...
    with open(os.path.join(ref_path,'ref/all_gsets.gmt'), 'r') as gmt:
...
def run_gsea(df, subsel=None, type='gsea', tmp_path=r'./tmp_gsea', **kwargs):
